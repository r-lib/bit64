...
test_that("integer64 coercion to/from other types work for R >=4.0.0", {
  ...
  skip_bst_tzone = "BST" %in% attr(as.POSIXlt(0), "tzone")
  ...
  expect_identical(as.POSIXlt(i64), as.POSIXlt(i32), ignore_attr=if (skip_bst_tzone) "tzone")
  ...
  expect_identical(methods::as(as.integer64(1:10), "POSIXlt"), as.POSIXlt(1:10), ignore_attr=if (skip_bst_tzone) "tzone")
