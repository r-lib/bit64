...
test_that("power with integer64", {
  ...
  expect_identical(as.integer64(10) ^ as.integer64(3), as.integer64(1000))
  expect_identical(as.integer64("2147483650") ^ as.integer64(2), as.integer64("4611686027017322500"))
  expect_identical(as.integer64(2) ^ 62L, as.integer64("4611686018427387904"))
  expect_identical(as.integer64(2) ^ as.integer64(62), as.integer64("4611686018427387904"))
  expect_identical(as.integer64(3) ^ 39L, as.integer64("4052555153018976267"))

  # Special bases: 0, 1, -1
  expect_identical(as.integer64(0) ^ 0L, as.integer64(1L))
  expect_identical(as.integer64(0) ^ 1L, as.integer64(0L))
  expect_identical(as.integer64(0) ^ 5L, as.integer64(0L))
  expect_warning(expect_identical(as.integer64(0) ^ (-1L), NA_integer64_))

  expect_identical(as.integer64(1) ^ 0L, as.integer64(1L))
  expect_identical(as.integer64(1) ^ 100L, as.integer64(1L))
  expect_identical(as.integer64(1) ^ (-5L), as.integer64(1L))
  expect_identical(as.integer64(1) ^ lim.integer64()[2L], as.integer64(1L))

  expect_identical(as.integer64(-1) ^ 0L, as.integer64(1L))
  expect_identical(as.integer64(-1) ^ 1L, as.integer64(-1L))
  expect_identical(as.integer64(-1) ^ 2L, as.integer64(1L))
  expect_identical(as.integer64(-1) ^ 3L, as.integer64(-1L))
  expect_identical(as.integer64(-1) ^ (-1L), as.integer64(-1L))
  expect_identical(as.integer64(-1) ^ (-2L), as.integer64(1L))
  expect_identical(as.integer64(-1) ^ (-3L), as.integer64(-1L))
  expect_identical(as.integer64(-1) ^ lim.integer64()[2L], as.integer64(-1L))
  ...
  expect_identical(as.integer64(2) ^ (-1L), as.integer64(0L))
  expect_identical(as.integer64(2) ^ (-5L), as.integer64(0L))
  expect_identical(as.integer64(-2) ^ (-1L), as.integer64(0L))
  ...
  expect_warning(expect_identical(as.integer64(100000) ^ 8L, NA_integer64_), overflow_warning)
  expect_warning(expect_identical(as.integer64(2) ^ 63L, NA_integer64_), overflow_warning)
  expect_warning(expect_identical(as.integer64(2) ^ 64L, NA_integer64_), overflow_warning)
  expect_warning(expect_identical(as.integer64(3) ^ 40L, NA_integer64_), overflow_warning)
  expect_warning(expect_identical(as.integer64(3) ^ 64L, NA_integer64_), overflow_warning)
  ...
  expect_no_warning(expect_identical(NA_integer64_ ^ 2L, NA_integer64_))
  expect_no_warning(expect_identical(as.integer64(2) ^ NA_integer_, NA_integer64_))
  expect_no_warning(expect_identical(as.integer64(2) ^ NA_integer64_, NA_integer64_))
  expect_no_warning(expect_identical(as.integer64(2) ^ NA_real_, NA_integer64_))
  expect_identical(integer64(0) ^ 2L, integer64(0))
  expect_identical(as.integer64(2) ^ integer(0), integer64(0))
  expect_identical(integer64(0) ^ integer(0), integer64(0))

  # Vectorization and recycling
  expect_identical(c(as.integer64(2), as.integer64(3)) ^ 2L, as.integer64(c(4, 9)))
  expect_identical(as.integer64(2) ^ c(1L, 2L, 3L), as.integer64(c(2, 4, 8)))
  expect_warning(
    expect_identical(c(as.integer64(2), as.integer64(2)) ^ c(2L, 64L), c(as.integer64(4), NA_integer64_)),
    overflow_warning
  )
})
