...
test_that("matrix multiplication", {
  ...
  expect_error(m64%*%LETTERS[1:5], "requires numeric/complex matrix/vector arguments", fixed=TRUE)
  expect_error(m64%*%as.factor(LETTERS[1:5]), "requires numeric/complex matrix/vector arguments", fixed=TRUE)
