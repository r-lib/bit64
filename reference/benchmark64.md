...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.006              0          0        0
#> factor   1.000   1.20     2.000            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.006          0.005          0        0
#> factor   1.000   1.20     2.000          2.400        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.006          0.005      0.009        0
#> factor   1.000   1.20     2.000          2.400      1.333      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.006          0.005      0.009    0.005
#> factor   1.000   1.20     2.000          2.400      1.333    2.400
#> 
...
#> SESSION        0.012   0.01     0.006          0.005      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION        0.012  0.010     0.006          0.005      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, b)        1    1.0       Inf            Inf        Inf
#> b %in% b         NaN    NaN       NaN            NaN        NaN
#> duplicated(b)    NaN    0.0         0            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    3.0         3            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN    0.0         0            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    0.0         0            NaN        NaN
#> summary(b)         1    1.0         1            Inf        Inf
#> factor(b)          1    2.0         2            Inf        Inf
#> SESSION            1    1.2         2            2.4      1.333
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    0.0         0            NaN        NaN
#> summary(b)         1    1.0         1            1.0        Inf
#> factor(b)          1    2.0         2            1.0        Inf
#> SESSION            1    1.2         2            2.4      1.333
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    0.0         0            NaN        NaN
#> summary(b)         1    1.0         1            1.0      1.000
#> factor(b)          1    2.0         2            1.0      2.000
#> SESSION            1    1.2         2            2.4      1.333
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
