...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.012         0              0          0        0
#> factor   1.000  1.167       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.012     0.008              0          0        0
#> factor   1.000  1.167     1.750            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.012     0.008          0.007          0        0
#> factor   1.000  1.167     1.750          2.000        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.012     0.008          0.007       0.01        0
#> factor   1.000  1.167     1.750          2.000       1.40      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.012     0.008          0.007       0.01    0.006
#> factor   1.000  1.167     1.750          2.000       1.40    2.333
#> 
...
#> sort(b)        0.001  0.000     0.000          0.000       0.00
#> order(b)       0.000  0.000     0.000          0.000       0.00
#> rank(b)        0.001  0.000     0.000          0.000       0.00
#> quantile(b)    0.001  0.000     0.000          0.000       0.00
#> summary(b)     0.001  0.000     0.000          0.000       0.00
#> factor(b)      0.001  0.000     0.000          0.000       0.00
#> SESSION        0.014  0.012     0.008          0.007       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> seconds              32-bit 64-bit hashcache sortordercache ordercache
#> cache          0.000  0.000     0.000          0.000       0.00
#> match(s, b)    0.000  0.001     0.000          0.000       0.00
#> s %in% b       0.000  0.000     0.000          0.000       0.00
#> match(b, s)    0.000  0.000     0.000          0.000       0.00
#> b %in% s       0.000  0.000     0.000          0.000       0.00
#> match(b, b)    0.000  0.000     0.000          0.000       0.00
...
#> order(b)       0.000  0.000     0.000          0.000       0.00
#> rank(b)        0.001  0.000     0.000          0.000       0.00
#> quantile(b)    0.001  0.001     0.000          0.000       0.00
#> summary(b)     0.001  0.001     0.000          0.000       0.00
#> factor(b)      0.001  0.001     0.000          0.000       0.00
#> SESSION        0.014  0.012     0.008          0.007       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> seconds              32-bit 64-bit hashcache sortordercache ordercache
#> cache          0.000  0.000     0.000          0.000       0.00
#> match(s, b)    0.000  0.001     0.001          0.000       0.00
#> s %in% b       0.000  0.000     0.000          0.000       0.00
#> match(b, s)    0.000  0.000     0.000          0.000       0.00
#> b %in% s       0.000  0.000     0.000          0.000       0.00
#> match(b, b)    0.000  0.000     0.000          0.000       0.00
...
#> factor(b)      0.001  0.001     0.001          0.000       0.00
#> SESSION        0.014  0.012     0.008          0.007       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN       NaN            NaN        NaN
#> match(s, b)      NaN  0.000      0.00            NaN        NaN
#> s %in% b         NaN    NaN       NaN            NaN        NaN
#> match(b, s)      NaN    NaN       NaN            NaN        NaN
#> b %in% s         NaN    NaN       NaN            NaN        NaN
#> match(b, b)      NaN    NaN       NaN            NaN        NaN
...
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)        1  1.000       Inf            Inf        Inf
#> summary(b)         1  1.000      1.00            Inf        Inf
#> factor(b)          1  1.000      1.00            Inf        Inf
#> SESSION            1  1.167      1.75              2        1.4
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> match(b, s)    0.000  0.000     0.000          0.000       0.00
#> b %in% s       0.000  0.000     0.000          0.000       0.00
#> match(b, b)    0.000  0.000     0.000          0.001       0.00
#> b %in% b       0.000  0.000     0.001          0.000       0.00
#> duplicated(b)  0.000  0.000     0.000          0.001       0.00
#> unique(b)      0.000  0.000     0.000          0.000       0.00
#> table(b)       0.002  0.001     0.000          0.001       0.00
#> sort(b)        0.001  0.000     0.000          0.000       0.00
#> order(b)       0.000  0.000     0.000          0.000       0.00
#> rank(b)        0.001  0.000     0.000          0.000       0.00
#> quantile(b)    0.001  0.001     0.000          0.001       0.00
#> summary(b)     0.001  0.001     0.001          0.000       0.00
#> factor(b)      0.001  0.001     0.001          0.001       0.00
#> SESSION        0.014  0.012     0.008          0.007       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> match(b, s)      NaN    NaN       NaN            NaN        NaN
#> b %in% s         NaN    NaN       NaN            NaN        NaN
#> match(b, b)      NaN    NaN       NaN              0        NaN
#> b %in% b         NaN    NaN      0.00            NaN        NaN
#> duplicated(b)    NaN    NaN       NaN              0        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1  2.000       Inf              2        Inf
#> sort(b)            1    Inf       Inf            Inf        Inf
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)        1  1.000       Inf              1        Inf
#> summary(b)         1  1.000      1.00            Inf        Inf
#> factor(b)          1  1.000      1.00              1        Inf
#> SESSION            1  1.167      1.75              2        1.4
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> factor(b)      0.001  0.001     0.001          0.001      0.001
#> SESSION        0.014  0.012     0.008          0.007      0.010
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, s)      NaN    NaN       NaN            NaN        NaN
#> b %in% s         NaN    NaN       NaN            NaN        NaN
#> match(b, b)      NaN    NaN       NaN              0        0.0
#> b %in% b         NaN    NaN      0.00            NaN        NaN
#> duplicated(b)    NaN    NaN       NaN              0        0.0
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1  2.000       Inf              2        2.0
#> sort(b)            1    Inf       Inf            Inf        Inf
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)        1  1.000       Inf              1        Inf
#> summary(b)         1  1.000      1.00            Inf        Inf
#> factor(b)          1  1.000      1.00              1        1.0
#> SESSION            1  1.167      1.75              2        1.4
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
