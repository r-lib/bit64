...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.007  0.009         0              0          0        0
#> factor   1.000  0.778       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.007  0.009     0.006              0          0        0
#> factor   1.000  0.778     1.167            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.007  0.009     0.006          0.004          0        0
#> factor   1.000  0.778     1.167          1.750        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.007  0.009     0.006          0.004      0.004        0
#> factor   1.000  0.778     1.167          1.750      1.750      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.007  0.009     0.006          0.004      0.004    0.004
#> factor   1.000  0.778     1.167          1.750      1.750    1.750
#> 
...
#> SESSION        0.007  0.009     0.006          0.004      0.004
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.778     1.167           1.75       1.75
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
...
#> b %in% s         NaN    NaN     0.000            NaN        NaN
#> match(b, b)      NaN  0.000       NaN            NaN        NaN
#> b %in% b           1    Inf       Inf           1.00        Inf
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf       Inf           2.00        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN  0.000       NaN            NaN        NaN
#> rank(b)          NaN    NaN       NaN            NaN        NaN
#> quantile(b)      NaN    NaN     0.000           0.00        NaN
#> summary(b)       NaN    NaN       NaN            NaN        NaN
...
#> SESSION          0.004
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN     0.000            NaN       0.00
#> match(s, b)      NaN    NaN       NaN            NaN        NaN
#> s %in% b         NaN    NaN       NaN            NaN        NaN
#> match(b, s)      NaN    NaN       NaN           0.00        NaN
#> b %in% s         NaN    NaN     0.000            NaN        NaN
#> match(b, b)      NaN  0.000       NaN            NaN        NaN
#> b %in% b           1    Inf       Inf           1.00       1.00
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf       Inf           2.00       2.00
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN  0.000       NaN            NaN        NaN
#> rank(b)          NaN    NaN       NaN            NaN        NaN
#> quantile(b)      NaN    NaN     0.000           0.00       0.00
#> summary(b)       NaN    NaN       NaN            NaN        NaN
#> factor(b)          1  2.000     2.000           2.00       2.00
#> SESSION            1  0.778     1.167           1.75       1.75
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
