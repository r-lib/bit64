...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.014     0.012          0.007          0        0
#> factor    1.00  0.714     0.833          1.429        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.014     0.012          0.007      0.006        0
#> factor    1.00  0.714     0.833          1.429      1.667      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.014     0.012          0.007      0.006    0.008
#> factor    1.00  0.714     0.833          1.429      1.667    1.250
#> 
...
#> SESSION        0.010  0.014     0.012          0.007      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.714     0.833          1.429      1.667
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
