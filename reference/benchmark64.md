...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.015     0.011              0          0        0
#> factor   1.000  0.733     1.000            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.015     0.011          0.005          0        0
#> factor   1.000  0.733     1.000          2.200        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.015     0.011          0.005      0.012        0
#> factor   1.000  0.733     1.000          2.200      0.917      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.015     0.011          0.005      0.012    0.009
#> factor   1.000  0.733     1.000          2.200      0.917    1.222
#> 
...
#> SESSION        0.011  0.015     0.011          0.005      0.012
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(s, b)      NaN  0.000         0            NaN        NaN
#> s %in% b           1  1.000       Inf            Inf        Inf
#> match(b, s)      NaN    NaN       NaN            NaN        NaN
#> b %in% s           1    Inf       Inf            Inf        Inf
#> match(b, b)      NaN    NaN         0            NaN        NaN
#> b %in% b           1  1.000         1            Inf        Inf
#> duplicated(b)    NaN  0.000         0            NaN        NaN
#> unique(b)          1    Inf       Inf            Inf        Inf
#> table(b)           1  2.000         2            Inf        Inf
#> sort(b)          NaN  0.000         0            NaN        NaN
...
#> match(s, b)    0.000  0.001     0.001          0.004      0.000
#> s %in% b       0.001  0.001     0.000          0.001      0.000
#> match(b, s)    0.000  0.000     0.000          0.001      0.000
#> b %in% s       0.001  0.000     0.000          0.002      0.000
...
#> match(s, b)      NaN  0.000         0            0.0        NaN
#> s %in% b           1  1.000       Inf            1.0        Inf
#> match(b, s)      NaN    NaN       NaN            0.0        NaN
#> b %in% s           1    Inf       Inf            0.5        Inf
#> match(b, b)      NaN    NaN         0            0.0        NaN
#> b %in% b           1  1.000         1            1.0        Inf
#> duplicated(b)    NaN  0.000         0            NaN        NaN
#> unique(b)          1    Inf       Inf            Inf        Inf
#> table(b)           1  2.000         2            2.0        Inf
#> sort(b)          NaN  0.000         0            NaN        NaN
#> order(b)         NaN  0.000         0            0.0        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN  0.000       NaN            0.0        NaN
#> summary(b)       NaN  0.000       NaN            0.0        NaN
#> SESSION            1  0.733         1            2.2      0.917
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> match(s, b)    0.000  0.001     0.001          0.004      0.000
#> s %in% b       0.001  0.001     0.000          0.001      0.001
#> match(b, s)    0.000  0.000     0.000          0.001      0.001
#> b %in% s       0.001  0.000     0.000          0.002      0.001
...
#> match(s, b)      NaN  0.000         0            0.0        NaN
#> s %in% b           1  1.000       Inf            1.0      1.000
#> match(b, s)      NaN    NaN       NaN            0.0      0.000
#> b %in% s           1    Inf       Inf            0.5      1.000
#> match(b, b)      NaN    NaN         0            0.0      0.000
#> b %in% b           1  1.000         1            1.0      1.000
#> duplicated(b)    NaN  0.000         0            NaN        NaN
#> unique(b)          1    Inf       Inf            Inf        Inf
#> table(b)           1  2.000         2            2.0        Inf
#> sort(b)          NaN  0.000         0            NaN        NaN
#> order(b)         NaN  0.000         0            0.0      0.000
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN  0.000       NaN            0.0      0.000
#> summary(b)       NaN  0.000       NaN            0.0        NaN
#> SESSION            1  0.733         1            2.2      0.917
#>               allcache
#> cache              NaN
