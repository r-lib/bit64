...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.012              0          0        0
#> factor   1.000  0.786     0.917            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.012          0.014          0        0
#> factor   1.000  0.786     0.917          0.786        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.012          0.014      0.009        0
#> factor   1.000  0.786     0.917          0.786      1.222      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.012          0.014      0.009    0.009
#> factor   1.000  0.786     0.917          0.786      1.222    1.222
#> 
...
#> SESSION        0.011  0.014     0.012          0.014      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.786     0.917          0.786      1.222
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
...
#> match(b, s)    0.000  0.000     0.004          0.000      0.000
...
#> match(b, s)    0.000  0.000     0.004          0.001      0.000
...
#> table(b)       0.002  0.001     0.000          0.000      0.000
#> sort(b)        0.000  0.001     0.000          0.001      0.000
#> order(b)       0.001  0.000     0.001          0.000      0.000
...
#> table(b)           1  2.000       Inf            Inf        Inf
#> sort(b)          NaN  0.000       NaN          0.000        NaN
#> order(b)           1    Inf     1.000            Inf        Inf
...
#> match(s, b)    0.000  0.000     0.000          0.001      0.000
#> s %in% b       0.000  0.000     0.001          0.001      0.000
#> match(b, s)    0.000  0.000     0.004          0.001      0.001
...
#> sort(b)        0.000  0.001     0.000          0.001      0.000
#> order(b)       0.001  0.000     0.001          0.000      0.001
#> rank(b)        0.001  0.000     0.000          0.001      0.000
