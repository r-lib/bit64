...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.011     0.008              0          0        0
#> factor   1.000  1.000     1.375            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.011     0.008          0.008          0        0
#> factor   1.000  1.000     1.375          1.375        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.011     0.008          0.008      0.006        0
#> factor   1.000  1.000     1.375          1.375      1.833      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.011     0.008          0.008      0.006    0.005
#> factor   1.000  1.000     1.375          1.375      1.833    2.200
#> 
...
#> SESSION        0.011  0.011     0.008          0.008      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> duplicated(b)      1    Inf       Inf            Inf        Inf
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1      2       Inf            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN      0       NaN            NaN        NaN
#> rank(b)          NaN    NaN       NaN            NaN        NaN
#> quantile(b)      NaN      0       NaN            NaN        NaN
#> summary(b)         1      1       Inf            Inf        Inf
#> factor(b)          1      2       Inf            Inf        Inf
#> SESSION            1      1     1.375          1.375      1.833
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
...
#> order(b)         NaN      0       NaN            NaN        NaN
#> rank(b)          NaN    NaN     0.000            NaN        NaN
#> quantile(b)      NaN      0       NaN            NaN        NaN
#> summary(b)         1      1     1.000            Inf        Inf
#> factor(b)          1      2     1.000            Inf        Inf
#> SESSION            1      1     1.375          1.375      1.833
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
...
#> quantile(b)    0.000  0.001     0.000          0.000      0.000
#> summary(b)     0.001  0.001     0.001          0.000      0.000
#> factor(b)      0.002  0.001     0.002          0.002      0.000
#> SESSION        0.011  0.011     0.008          0.008      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> summary(b)     0.001  0.001     0.001          0.000      0.000
#> factor(b)      0.002  0.001     0.002          0.002      0.001
#> SESSION        0.011  0.011     0.008          0.008      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> order(b)         NaN      0       NaN            NaN        NaN
#> rank(b)          NaN    NaN     0.000            NaN        NaN
#> quantile(b)      NaN      0       NaN            NaN      0.000
#> summary(b)         1      1     1.000            Inf        Inf
#> factor(b)          1      2     1.000          1.000      2.000
#> SESSION            1      1     1.375          1.375      1.833
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
