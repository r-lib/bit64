...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015   0.01     0.008              0          0        0
#> factor   1.000   1.50     1.875            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015   0.01     0.008          0.008          0        0
#> factor   1.000   1.50     1.875          1.875        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015   0.01     0.008          0.008      0.013        0
#> factor   1.000   1.50     1.875          1.875      1.154      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015   0.01     0.008          0.008      0.013    0.005
#> factor   1.000   1.50     1.875          1.875      1.154    3.000
#> 
...
#> SESSION        0.015   0.01     0.008          0.008      0.013
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1    1.5     1.875          1.875      1.154
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
...
#> SESSION        0.015  0.010     0.008          0.008      0.013
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, s)      NaN    NaN       NaN            NaN        NaN
#> b %in% s         NaN    NaN       NaN            NaN        NaN
#> match(b, b)        1    Inf     1.000          1.000        Inf
#> b %in% b         NaN    NaN       NaN            NaN        NaN
#> duplicated(b)    NaN    0.0       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    3.0       Inf          3.000        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    NaN     0.000            NaN        NaN
#> summary(b)       NaN    0.0       NaN          0.000        NaN
