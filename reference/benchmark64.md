...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015   0.01         0              0          0        0
#> factor   1.000   1.50       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015   0.01     0.007              0          0        0
#> factor   1.000   1.50     2.143            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015   0.01     0.007          0.004          0        0
#> factor   1.000   1.50     2.143          3.750        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015   0.01     0.007          0.004       0.01        0
#> factor   1.000   1.50     2.143          3.750       1.50      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015   0.01     0.007          0.004       0.01    0.006
#> factor   1.000   1.50     2.143          3.750       1.50    2.500
#> 
...
#> cache          0.000   0.00     0.000          0.000       0.00
#> match(s, b)    0.000   0.00     0.000          0.000       0.00
#> s %in% b       0.000   0.00     0.000          0.000       0.00
#> match(b, s)    0.000   0.00     0.000          0.000       0.00
#> b %in% s       0.000   0.00     0.000          0.000       0.00
#> match(b, b)    0.000   0.00     0.000          0.000       0.00
#> b %in% b       0.000   0.00     0.000          0.000       0.00
#> duplicated(b)  0.000   0.00     0.000          0.000       0.00
#> unique(b)      0.000   0.00     0.000          0.000       0.00
#> table(b)       0.002   0.00     0.000          0.000       0.00
#> sort(b)        0.000   0.00     0.000          0.000       0.00
#> order(b)       0.000   0.00     0.000          0.000       0.00
#> rank(b)        0.000   0.00     0.000          0.000       0.00
#> quantile(b)    0.000   0.00     0.000          0.000       0.00
#> summary(b)     0.001   0.00     0.000          0.000       0.00
#> factor(b)      0.002   0.00     0.000          0.000       0.00
#> SESSION        0.015   0.01     0.007          0.004       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, s)    0.000  0.000     0.000          0.000       0.00
#> b %in% s       0.000  0.000     0.000          0.000       0.00
#> match(b, b)    0.000  0.000     0.000          0.000       0.00
#> b %in% b       0.000  0.000     0.000          0.000       0.00
#> duplicated(b)  0.000  0.000     0.000          0.000       0.00
...
#> b %in% s       0.000  0.000     0.000          0.000       0.00
#> match(b, b)    0.000  0.000     0.000          0.000       0.00
#> b %in% b       0.000  0.000     0.001          0.000       0.00
#> duplicated(b)  0.000  0.000     0.000          0.000       0.00
#> unique(b)      0.000  0.000     0.000          0.000       0.00
#> table(b)       0.002  0.000     0.000          0.000       0.00
#> sort(b)        0.000  0.001     0.000          0.000       0.00
#> order(b)       0.000  0.000     0.000          0.000       0.00
#> rank(b)        0.000  0.001     0.001          0.000       0.00
#> quantile(b)    0.000  0.000     0.000          0.000       0.00
#> summary(b)     0.001  0.000     0.001          0.000       0.00
#> factor(b)      0.002  0.001     0.002          0.000       0.00
#> SESSION        0.015  0.010     0.007          0.004       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> b %in% s         NaN    NaN       NaN            NaN        NaN
#> match(b, b)      NaN    NaN       NaN            NaN        NaN
#> b %in% b         NaN    NaN     0.000            NaN        NaN
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf       Inf            Inf        Inf
#> sort(b)          NaN    0.0       NaN            NaN        NaN
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)          NaN    0.0     0.000            NaN        NaN
#> quantile(b)      NaN    NaN       NaN            NaN        NaN
#> summary(b)         1    Inf     1.000            Inf        Inf
...
#> b %in% s       0.000  0.000     0.000          0.000       0.00
#> match(b, b)    0.000  0.000     0.000          0.000       0.00
#> b %in% b       0.000  0.000     0.001          0.001       0.00
#> duplicated(b)  0.000  0.000     0.000          0.000       0.00
...
#> order(b)       0.000  0.000     0.000          0.000       0.00
#> rank(b)        0.000  0.001     0.001          0.000       0.00
#> quantile(b)    0.000  0.000     0.000          0.001       0.00
#> summary(b)     0.001  0.000     0.001          0.000       0.00
#> factor(b)      0.002  0.001     0.002          0.001       0.00
#> SESSION        0.015  0.010     0.007          0.004       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> b %in% s         NaN    NaN       NaN            NaN        NaN
#> match(b, b)      NaN    NaN       NaN            NaN        NaN
#> b %in% b         NaN    NaN     0.000           0.00        NaN
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN           0.00        NaN
#> table(b)           1    Inf       Inf            Inf        Inf
#> sort(b)          NaN    0.0       NaN            NaN        NaN
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)          NaN    0.0     0.000            NaN        NaN
#> quantile(b)      NaN    NaN       NaN           0.00        NaN
#> summary(b)         1    Inf     1.000            Inf        Inf
#> factor(b)          1    2.0     1.000           2.00        Inf
#> SESSION            1    1.5     2.143           3.75        1.5
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> rank(b)        0.000  0.001     0.001          0.000      0.000
#> quantile(b)    0.000  0.000     0.000          0.001      0.000
#> summary(b)     0.001  0.000     0.001          0.000      0.001
#> factor(b)      0.002  0.001     0.002          0.001      0.001
#> SESSION        0.015  0.010     0.007          0.004      0.010
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION          0.006
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN       NaN            NaN        0.0
#> match(s, b)      NaN    NaN       NaN            NaN        NaN
#> s %in% b         NaN    NaN       NaN            NaN        NaN
#> match(b, s)      NaN    NaN       NaN            NaN        NaN
#> b %in% s         NaN    NaN       NaN            NaN        NaN
#> match(b, b)      NaN    NaN       NaN            NaN        NaN
#> b %in% b         NaN    NaN     0.000           0.00        0.0
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN           0.00        0.0
#> table(b)           1    Inf       Inf            Inf        Inf
#> sort(b)          NaN    0.0       NaN            NaN        NaN
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)          NaN    0.0     0.000            NaN        NaN
#> quantile(b)      NaN    NaN       NaN           0.00        NaN
#> summary(b)         1    Inf     1.000            Inf        1.0
#> factor(b)          1    2.0     1.000           2.00        2.0
#> SESSION            1    1.5     2.143           3.75        1.5
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
