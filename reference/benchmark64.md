...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.012         0              0          0        0
#> factor   1.000  1.250       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.012     0.008              0          0        0
#> factor   1.000  1.250     1.875            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.012     0.008          0.009          0        0
#> factor   1.000  1.250     1.875          1.667        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.012     0.008          0.009      0.007        0
#> factor   1.000  1.250     1.875          1.667      2.143      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.012     0.008          0.009      0.007    0.006
#> factor   1.000  1.250     1.875          1.667      2.143    2.500
#> 
...
#> SESSION        0.015  0.012     0.008          0.009      0.007
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1   1.25     1.875          1.667      2.143
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           Inf
...
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN       NaN            NaN        NaN
#> match(s, b)      NaN   0.00       NaN            NaN        NaN
#> s %in% b           1   1.00       Inf            Inf        Inf
#> match(b, s)      NaN   0.00       NaN            NaN        NaN
#> b %in% s           1   1.00       Inf            Inf        Inf
#> match(b, b)      NaN   0.00       NaN            NaN        NaN
#> b %in% b           1   1.00       Inf            Inf        Inf
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)          1    Inf       Inf            Inf        Inf
#> table(b)           1   2.00       Inf            Inf        Inf
#> sort(b)            1    Inf       Inf            Inf        Inf
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)            1   1.00       Inf            Inf        Inf
#> quantile(b)      NaN   0.00       NaN            NaN        NaN
#> summary(b)         1   1.00       Inf            Inf        Inf
#> SESSION            1   1.25     1.875          1.667      2.143
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> s %in% b       0.001  0.001     0.004          0.000      0.000
#> match(b, s)    0.000  0.001     0.000          0.000      0.000
#> b %in% s       0.001  0.001     0.000          0.000      0.000
#> match(b, b)    0.000  0.001     0.000          0.000      0.000
#> b %in% b       0.001  0.001     0.000          0.000      0.000
...
#> sort(b)        0.001  0.000     0.001          0.000      0.000
...
#> match(s, b)      NaN   0.00     0.000            NaN        NaN
#> s %in% b           1   1.00     0.250            Inf        Inf
#> match(b, s)      NaN   0.00       NaN            NaN        NaN
#> b %in% s           1   1.00       Inf            Inf        Inf
#> match(b, b)      NaN   0.00       NaN            NaN        NaN
#> b %in% b           1   1.00       Inf            Inf        Inf
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)          1    Inf       Inf            Inf        Inf
#> table(b)           1   2.00     2.000            Inf        Inf
#> sort(b)            1    Inf     1.000            Inf        Inf
#> order(b)         NaN    NaN     0.000            NaN        NaN
#> rank(b)            1   1.00       Inf            Inf        Inf
#> quantile(b)      NaN   0.00     0.000            NaN        NaN
#> summary(b)         1   1.00     1.000            Inf        Inf
#> SESSION            1   1.25     1.875          1.667      2.143
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> s %in% b       0.001  0.001     0.004          0.000      0.000
#> match(b, s)    0.000  0.001     0.000          0.000      0.000
#> b %in% s       0.001  0.001     0.000          0.001      0.000
#> match(b, b)    0.000  0.001     0.000          0.001      0.000
...
#> s %in% b           1   1.00     0.250            Inf        Inf
#> match(b, s)      NaN   0.00       NaN            NaN        NaN
#> b %in% s           1   1.00       Inf          1.000        Inf
#> match(b, b)      NaN   0.00       NaN          0.000        NaN
#> b %in% b           1   1.00       Inf          1.000        Inf
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)          1    Inf       Inf            Inf        Inf
#> table(b)           1   2.00     2.000          2.000        Inf
#> sort(b)            1    Inf     1.000            Inf        Inf
#> order(b)         NaN    NaN     0.000          0.000        NaN
#> rank(b)            1   1.00       Inf            Inf        Inf
#> quantile(b)      NaN   0.00     0.000          0.000        NaN
#> summary(b)         1   1.00     1.000            Inf        Inf
#> SESSION            1   1.25     1.875          1.667      2.143
#>               allcache
#> cache              NaN
...
#> match(s, b)    0.000  0.001     0.001          0.000      0.001
#> s %in% b       0.001  0.001     0.004          0.000      0.000
#> match(b, s)    0.000  0.001     0.000          0.000      0.000
#> b %in% s       0.001  0.001     0.000          0.001      0.000
#> match(b, b)    0.000  0.001     0.000          0.001      0.001
#> b %in% b       0.001  0.001     0.000          0.001      0.001
#> duplicated(b)  0.000  0.000     0.000          0.000      0.001
#> unique(b)      0.001  0.000     0.000          0.000      0.000
#> table(b)       0.002  0.001     0.001          0.001      0.001
#> sort(b)        0.001  0.000     0.001          0.000      0.000
#> order(b)       0.000  0.000     0.001          0.001      0.001
#> rank(b)        0.001  0.001     0.000          0.000      0.000
...
#> match(s, b)      NaN   0.00     0.000            NaN      0.000
#> s %in% b           1   1.00     0.250            Inf        Inf
#> match(b, s)      NaN   0.00       NaN            NaN        NaN
#> b %in% s           1   1.00       Inf          1.000        Inf
#> match(b, b)      NaN   0.00       NaN          0.000      0.000
#> b %in% b           1   1.00       Inf          1.000      1.000
#> duplicated(b)    NaN    NaN       NaN            NaN      0.000
#> unique(b)          1    Inf       Inf            Inf        Inf
#> table(b)           1   2.00     2.000          2.000      2.000
#> sort(b)            1    Inf     1.000            Inf        Inf
#> order(b)         NaN    NaN     0.000          0.000      0.000
#> rank(b)            1   1.00       Inf            Inf        Inf
#> quantile(b)      NaN   0.00     0.000          0.000      0.000
#> summary(b)         1   1.00     1.000            Inf      1.000
#> SESSION            1   1.25     1.875          1.667      2.143
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
