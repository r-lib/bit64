...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.014              0          0        0
#> factor   1.000  0.786     0.786            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.014          0.008          0        0
#> factor   1.000  0.786     0.786          1.375        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.014          0.008      0.014        0
#> factor   1.000  0.786     0.786          1.375      0.786      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.014          0.008      0.014    0.006
#> factor   1.000  0.786     0.786          1.375      0.786    1.833
#> 
...
#> SESSION        0.011  0.014     0.014          0.008      0.014
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.786     0.786          1.375      0.786
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           Inf
...
#> s %in% b       0.001  0.001     0.004          0.000      0.001
...
#> s %in% b           1  1.000     0.250            Inf      1.000
