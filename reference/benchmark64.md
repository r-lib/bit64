...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.013         0              0          0        0
#> factor   1.000  1.154       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.013     0.007              0          0        0
#> factor   1.000  1.154     2.143            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.013     0.007          0.007          0        0
#> factor   1.000  1.154     2.143          2.143        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.013     0.007          0.007      0.007        0
#> factor   1.000  1.154     2.143          2.143      2.143      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.015  0.013     0.007          0.007      0.007    0.009
#> factor   1.000  1.154     2.143          2.143      2.143    1.667
#> 
...
#> SESSION        0.015  0.013     0.007          0.007      0.007
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  1.154     2.143          2.143      2.143
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
#> s %in% b           NaN
