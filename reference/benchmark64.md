...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.017         0              0          0        0
#> factor   1.000  0.647       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.017     0.011              0          0        0
#> factor   1.000  0.647     1.000            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.017     0.011          0.009          0        0
#> factor   1.000  0.647     1.000          1.222        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.017     0.011          0.009      0.012        0
#> factor   1.000  0.647     1.000          1.222      0.917      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.017     0.011          0.009      0.012    0.011
#> factor   1.000  0.647     1.000          1.222      0.917    1.000
#> 
...
#> SESSION        0.011  0.017     0.011          0.009      0.012
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, s)      NaN  0.000         0          0.000        NaN
...
#> match(b, s)      NaN  0.000         0          0.000      0.000
#> b %in% s         NaN  0.000         0          0.000        NaN
#> match(b, b)        1  1.000         1          1.000        Inf
#> b %in% b         NaN  0.000         0          0.000        NaN
#> duplicated(b)      1  1.000       Inf            Inf        Inf
