...
#> seconds   0.01      0         0              0          0        0
#> factor    1.00    Inf       Inf            Inf        Inf      Inf
#> 
#> === 64-bit ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.019         0              0          0        0
#> factor    1.00  0.526       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.019     0.008              0          0        0
#> factor    1.00  0.526     1.250            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.019     0.008           0.01          0        0
#> factor    1.00  0.526     1.250           1.00        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.019     0.008           0.01      0.011        0
#> factor    1.00  0.526     1.250           1.00      0.909      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.019     0.008           0.01      0.011     0.01
#> factor    1.00  0.526     1.250           1.00      0.909     1.00
#> 
...
#> s %in% b       0.000  0.000     0.000           0.00      0.000
#> match(b, s)    0.001  0.000     0.000           0.00      0.000
#> b %in% s       0.000  0.000     0.000           0.00      0.000
#> match(b, b)    0.001  0.000     0.000           0.00      0.000
#> b %in% b       0.000  0.000     0.000           0.00      0.000
#> duplicated(b)  0.000  0.000     0.000           0.00      0.000
#> unique(b)      0.000  0.000     0.000           0.00      0.000
#> table(b)       0.002  0.000     0.000           0.00      0.000
#> sort(b)        0.000  0.000     0.000           0.00      0.000
#> order(b)       0.000  0.000     0.000           0.00      0.000
#> rank(b)        0.000  0.000     0.000           0.00      0.000
#> quantile(b)    0.000  0.000     0.000           0.00      0.000
#> summary(b)     0.001  0.000     0.000           0.00      0.000
#> SESSION        0.010  0.019     0.008           0.01      0.011
#>               allcache
#> cache             0.00
#> match(s, b)       0.00
#> s %in% b          0.00
...
#> match(s, b)    0.000  0.000     0.000           0.00      0.000
#> s %in% b       0.000  0.000     0.000           0.00      0.000
#> match(b, s)    0.001  0.001     0.000           0.00      0.000
#> b %in% s       0.000  0.001     0.000           0.00      0.000
#> match(b, b)    0.001  0.001     0.000           0.00      0.000
#> b %in% b       0.000  0.001     0.000           0.00      0.000
...
#> order(b)       0.000  0.000     0.000           0.00      0.000
#> rank(b)        0.000  0.000     0.000           0.00      0.000
#> quantile(b)    0.000  0.001     0.000           0.00      0.000
#> summary(b)     0.001  0.001     0.000           0.00      0.000
#> SESSION        0.010  0.019     0.008           0.01      0.011
#>               allcache
#> cache             0.00
#> match(s, b)       0.00
...
#> match(s, b)      NaN    NaN       NaN            NaN        NaN
#> s %in% b         NaN    NaN       NaN            NaN        NaN
#> match(b, s)        1  1.000       Inf            Inf        Inf
#> b %in% s         NaN  0.000       NaN            NaN        NaN
#> match(b, b)        1  1.000       Inf            Inf        Inf
#> b %in% b         NaN  0.000       NaN            NaN        NaN
...
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)          NaN    NaN       NaN            NaN        NaN
#> quantile(b)      NaN  0.000       NaN            NaN        NaN
#> summary(b)         1  1.000       Inf            Inf        Inf
#> SESSION            1  0.526      1.25              1      0.909
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> seconds              32-bit 64-bit hashcache sortordercache ordercache
#> cache          0.000  0.000     0.000           0.00      0.000
#> match(s, b)    0.000  0.000     0.001           0.00      0.000
#> s %in% b       0.000  0.000     0.001           0.00      0.000
#> match(b, s)    0.001  0.001     0.001           0.00      0.000
#> b %in% s       0.000  0.001     0.001           0.00      0.000
#> match(b, b)    0.001  0.001     0.001           0.00      0.000
#> b %in% b       0.000  0.001     0.001           0.00      0.000
#> duplicated(b)  0.000  0.001     0.000           0.00      0.000
#> unique(b)      0.000  0.000     0.000           0.00      0.000
#> table(b)       0.002  0.001     0.000           0.00      0.000
#> sort(b)        0.000  0.000     0.000           0.00      0.000
#> order(b)       0.000  0.000     0.001           0.00      0.000
#> rank(b)        0.000  0.000     0.001           0.00      0.000
#> quantile(b)    0.000  0.001     0.001           0.00      0.000
#> summary(b)     0.001  0.001     0.004           0.00      0.000
#> SESSION        0.010  0.019     0.008           0.01      0.011
#>               allcache
#> cache             0.00
#> match(s, b)       0.00
...
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN       NaN            NaN        NaN
#> match(s, b)      NaN    NaN      0.00            NaN        NaN
#> s %in% b         NaN    NaN      0.00            NaN        NaN
#> match(b, s)        1  1.000      1.00            Inf        Inf
#> b %in% s         NaN  0.000      0.00            NaN        NaN
#> match(b, b)        1  1.000      1.00            Inf        Inf
#> b %in% b         NaN  0.000      0.00            NaN        NaN
#> duplicated(b)    NaN  0.000       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1  2.000       Inf            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN    NaN      0.00            NaN        NaN
#> rank(b)          NaN    NaN      0.00            NaN        NaN
#> quantile(b)      NaN  0.000      0.00            NaN        NaN
#> summary(b)         1  1.000      0.25            Inf        Inf
#> SESSION            1  0.526      1.25              1      0.909
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> match(s, b)    0.000  0.000     0.001          0.000      0.000
#> s %in% b       0.000  0.000     0.001          0.000      0.000
#> match(b, s)    0.001  0.001     0.001          0.000      0.000
#> b %in% s       0.000  0.001     0.001          0.000      0.000
#> match(b, b)    0.001  0.001     0.001          0.001      0.000
#> b %in% b       0.000  0.001     0.001          0.001      0.000
...
#> order(b)       0.000  0.000     0.001          0.001      0.000
#> rank(b)        0.000  0.000     0.001          0.000      0.000
#> quantile(b)    0.000  0.001     0.001          0.001      0.000
#> summary(b)     0.001  0.001     0.004          0.000      0.000
#> SESSION        0.010  0.019     0.008          0.010      0.011
#>               allcache
#> cache             0.00
#> match(s, b)       0.00
#> s %in% b          0.00
...
#> match(b, s)        1  1.000      1.00            Inf        Inf
#> b %in% s         NaN  0.000      0.00            NaN        NaN
#> match(b, b)        1  1.000      1.00              1        Inf
#> b %in% b         NaN  0.000      0.00              0        NaN
#> duplicated(b)    NaN  0.000       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1  2.000       Inf              2        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN    NaN      0.00              0        NaN
#> rank(b)          NaN    NaN      0.00            NaN        NaN
#> quantile(b)      NaN  0.000      0.00              0        NaN
#> summary(b)         1  1.000      0.25            Inf        Inf
#> SESSION            1  0.526      1.25              1      0.909
#>               allcache
#> cache              NaN
...
#> match(s, b)    0.000  0.000     0.001          0.000      0.001
#> s %in% b       0.000  0.000     0.001          0.000      0.001
#> match(b, s)    0.001  0.001     0.001          0.000      0.001
#> b %in% s       0.000  0.001     0.001          0.000      0.000
#> match(b, b)    0.001  0.001     0.001          0.001      0.000
#> b %in% b       0.000  0.001     0.001          0.001      0.000
#> duplicated(b)  0.000  0.001     0.000          0.000      0.000
...
#> rank(b)        0.000  0.000     0.001          0.000      0.000
#> quantile(b)    0.000  0.001     0.001          0.001      0.000
#> summary(b)     0.001  0.001     0.004          0.000      0.001
#> SESSION        0.010  0.019     0.008          0.010      0.011
#>               allcache
#> cache             0.00
#> match(s, b)       0.00
...
#> match(s, b)      NaN    NaN      0.00            NaN      0.000
#> s %in% b         NaN    NaN      0.00            NaN      0.000
#> match(b, s)        1  1.000      1.00            Inf      1.000
#> b %in% s         NaN  0.000      0.00            NaN        NaN
#> match(b, b)        1  1.000      1.00              1        Inf
#> b %in% b         NaN  0.000      0.00              0        NaN
#> duplicated(b)    NaN  0.000       NaN            NaN        NaN
...
#> rank(b)          NaN    NaN      0.00            NaN        NaN
#> quantile(b)      NaN  0.000      0.00              0        NaN
#> summary(b)         1  1.000      0.25            Inf      1.000
#> SESSION            1  0.526      1.25              1      0.909
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
