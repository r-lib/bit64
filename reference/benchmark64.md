...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.011     0.006              0          0        0
#> factor   1.000  1.091     2.000            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.011     0.006          0.008          0        0
#> factor   1.000  1.091     2.000          1.500        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.011     0.006          0.008      0.006        0
#> factor   1.000  1.091     2.000          1.500      2.000      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.011     0.006          0.008      0.006    0.007
#> factor   1.000  1.091     2.000          1.500      2.000    1.714
#> 
...
#> SESSION        0.012  0.011     0.006          0.008      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> order(b)         NaN    NaN         0            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    NaN         0            0.0        NaN
#> summary(b)         1  1.000         1            Inf        Inf
#> factor(b)          1  1.000         1            1.0        Inf
#> SESSION            1  1.091         2            1.5          2
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> duplicated(b)    NaN  0.000         0            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1  2.000         2            Inf          2
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN    NaN         0            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    NaN         0            0.0          0
#> summary(b)         1  1.000         1            Inf          1
#> factor(b)          1  1.000         1            1.0          1
#> SESSION            1  1.091         2            1.5          2
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
