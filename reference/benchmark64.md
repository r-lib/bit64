...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.008  0.014     0.013              0          0        0
#> factor   1.000  0.571     0.615            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.008  0.014     0.013          0.011          0        0
#> factor   1.000  0.571     0.615          0.727        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.008  0.014     0.013          0.011      0.009        0
#> factor   1.000  0.571     0.615          0.727      0.889      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.008  0.014     0.013          0.011      0.009    0.005
#> factor   1.000  0.571     0.615          0.727      0.889    1.600
#> 
...
#> SESSION        0.008  0.014     0.013          0.011      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.571     0.615          0.727      0.889
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           Inf
...
#> s %in% b           1  1.000     1.000          1.000        Inf
#> match(b, s)      NaN  0.000       NaN            NaN        NaN
#> b %in% s           1  1.000       Inf            Inf        Inf
#> match(b, b)      NaN  0.000     0.000            NaN        NaN
#> b %in% b         NaN  0.000     0.000            NaN        NaN
...
#> s %in% b           1  1.000     1.000          1.000      1.000
