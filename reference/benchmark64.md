...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.017         0              0          0        0
#> factor   1.000  0.529       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.017     0.011              0          0        0
#> factor   1.000  0.529     0.818            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.017     0.011          0.006          0        0
#> factor   1.000  0.529     0.818          1.500        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.017     0.011          0.006      0.014        0
#> factor   1.000  0.529     0.818          1.500      0.643      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.017     0.011          0.006      0.014    0.007
#> factor   1.000  0.529     0.818          1.500      0.643    1.286
#> 
...
#> SESSION        0.009  0.017     0.011          0.006      0.014
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.529     0.818            1.5      0.643
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           Inf
...
#> match(s, b)      NaN  0.000       NaN            NaN        NaN
#> s %in% b           1  1.000       Inf            Inf        Inf
#> match(b, s)      NaN  0.000       NaN            0.0        NaN
#> b %in% s           1  1.000       Inf            1.0        Inf
#> match(b, b)      NaN  0.000       NaN            0.0        NaN
#> b %in% b           1  1.000       Inf            1.0        Inf
#> duplicated(b)    NaN  0.000       NaN            0.0        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1  2.000       Inf            2.0        Inf
#> sort(b)          NaN  0.000     0.000            NaN        NaN
#> order(b)         NaN  0.000     0.000            0.0        NaN
#> rank(b)            1    Inf     1.000            Inf        Inf
#> quantile(b)      NaN    NaN     0.000            0.0        NaN
...
#> s %in% b       0.001  0.001     0.000          0.000      0.001
#> match(b, s)    0.000  0.001     0.000          0.001      0.001
#> b %in% s       0.001  0.001     0.000          0.001      0.001
...
#> match(s, b)      NaN  0.000       NaN            NaN      0.000
#> s %in% b           1  1.000       Inf            Inf      1.000
#> match(b, s)      NaN  0.000       NaN            0.0      0.000
#> b %in% s           1  1.000       Inf            1.0      1.000
#> match(b, b)      NaN  0.000       NaN            0.0      0.000
#> b %in% b           1  1.000       Inf            1.0      1.000
#> duplicated(b)    NaN  0.000       NaN            0.0        NaN
#> unique(b)        NaN    NaN       NaN            NaN      0.000
#> table(b)           1  2.000       Inf            2.0        Inf
#> sort(b)          NaN  0.000     0.000            NaN        NaN
#> order(b)         NaN  0.000     0.000            0.0      0.000
#> rank(b)            1    Inf     1.000            Inf        Inf
#> quantile(b)      NaN    NaN     0.000            0.0      0.000
#> summary(b)         1  1.000     1.000            1.0        Inf
#> SESSION            1  0.529     0.818            1.5      0.643
#>               allcache
#> cache              NaN
