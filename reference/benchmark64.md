...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.013     0.014              0          0        0
#> factor    1.00  0.769     0.714            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.013     0.014          0.005          0        0
#> factor    1.00  0.769     0.714          2.000        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.013     0.014          0.005      0.013        0
#> factor    1.00  0.769     0.714          2.000      0.769      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.013     0.014          0.005      0.013    0.004
#> factor    1.00  0.769     0.714          2.000      0.769    2.500
#> 
...
#> SESSION        0.010  0.013     0.014          0.005      0.013
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> duplicated(b)      1  1.000     1.000            Inf        Inf
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf     2.000            Inf        Inf
#> sort(b)          NaN  0.000     0.000            NaN        NaN
...
#> match(s, b)    0.001  0.001     0.000          0.000      0.000
#> s %in% b       0.000  0.000     0.000          0.005      0.000
#> match(b, s)    0.000  0.000     0.000          0.001      0.000
#> b %in% s       0.000  0.000     0.001          0.001      0.000
#> match(b, b)    0.001  0.000     0.001          0.001      0.000
...
#> summary(b)     0.000  0.001     0.000          0.001      0.000
#> SESSION        0.010  0.013     0.014          0.005      0.013
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> SESSION          0.004
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN     0.000              0        NaN
#> match(s, b)        1  1.000       Inf            Inf        Inf
#> s %in% b         NaN    NaN       NaN              0        NaN
#> match(b, s)      NaN    NaN       NaN              0        NaN
#> b %in% s         NaN    NaN     0.000              0        NaN
#> match(b, b)        1    Inf     1.000              1        Inf
#> b %in% b         NaN  0.000     0.000              0        NaN
#> duplicated(b)      1  1.000     1.000              1        Inf
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf     2.000              2        Inf
#> sort(b)          NaN  0.000     0.000            NaN        NaN
#> order(b)         NaN  0.000     0.000              0        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    NaN       NaN              0        NaN
#> summary(b)       NaN  0.000       NaN              0        NaN
#> SESSION            1  0.769     0.714              2      0.769
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
...
#> match(s, b)    0.001  0.001     0.000          0.000      0.000
#> s %in% b       0.000  0.000     0.000          0.005      0.001
#> match(b, s)    0.000  0.000     0.000          0.001      0.001
#> b %in% s       0.000  0.000     0.001          0.001      0.001
#> match(b, b)    0.001  0.000     0.001          0.001      0.001
...
#> SESSION          0.004
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN     0.000              0      0.000
#> match(s, b)        1  1.000       Inf            Inf        Inf
#> s %in% b         NaN    NaN       NaN              0      0.000
#> match(b, s)      NaN    NaN       NaN              0      0.000
#> b %in% s         NaN    NaN     0.000              0      0.000
#> match(b, b)        1    Inf     1.000              1      1.000
#> b %in% b         NaN  0.000     0.000              0      0.000
#> duplicated(b)      1  1.000     1.000              1        Inf
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf     2.000              2        Inf
#> sort(b)          NaN  0.000     0.000            NaN        NaN
