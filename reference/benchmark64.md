...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.012         0              0          0        0
#> factor    1.00  0.833       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.012     0.017              0          0        0
#> factor    1.00  0.833     0.588            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.012     0.017          0.006          0        0
#> factor    1.00  0.833     0.588          1.667        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.012     0.017          0.006      0.011        0
#> factor    1.00  0.833     0.588          1.667      0.909      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.012     0.017          0.006      0.011    0.012
#> factor    1.00  0.833     0.588          1.667      0.909    0.833
#> 
...
#> SESSION        0.010  0.012     0.017          0.006      0.011
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.833     0.588          1.667      0.909
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
#> s %in% b           NaN
...
#> b %in% b           1  1.000       Inf            Inf        Inf
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)          1    Inf       Inf          1.000        Inf
#> table(b)           1  2.000     2.000            Inf        Inf
#> sort(b)            1    Inf       Inf            Inf        Inf
#> order(b)         NaN  0.000       NaN            NaN        NaN
#> rank(b)            1  1.000       Inf            Inf        Inf
#> quantile(b)        1  1.000     1.000          1.000        Inf
#> summary(b)       NaN  0.000     0.000            NaN        NaN
#> SESSION            1  0.833     0.588          1.667      0.909
#>               allcache
#> cache              NaN
