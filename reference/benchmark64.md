...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.012         0              0          0        0
#> factor   1.000  1.083       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.012     0.005              0          0        0
#> factor   1.000  1.083     2.600            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.012     0.005          0.008          0        0
#> factor   1.000  1.083     2.600          1.625        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.012     0.005          0.008       0.01        0
#> factor   1.000  1.083     2.600          1.625       1.30      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.012     0.005          0.008       0.01    0.005
#> factor   1.000  1.083     2.600          1.625       1.30    2.600
#> 
...
#> table(b)       0.003  0.000     0.000          0.000       0.00
#> sort(b)        0.000  0.000     0.000          0.000       0.00
#> order(b)       0.001  0.000     0.000          0.000       0.00
#> rank(b)        0.001  0.000     0.000          0.000       0.00
#> quantile(b)    0.000  0.000     0.000          0.000       0.00
#> summary(b)     0.000  0.000     0.000          0.000       0.00
#> factor(b)      0.002  0.000     0.000          0.000       0.00
#> SESSION        0.013  0.012     0.005          0.008       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> summary(b)     0.000  0.001     0.000          0.000       0.00
#> factor(b)      0.002  0.001     0.000          0.000       0.00
#> SESSION        0.013  0.012     0.005          0.008       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> hashcache factor(b)
#> seconds              32-bit 64-bit hashcache sortordercache ordercache
#> cache          0.000  0.000     0.001          0.000       0.00
#> match(s, b)    0.001  0.000     0.000          0.000       0.00
#> s %in% b       0.000  0.000     0.000          0.000       0.00
#> match(b, s)    0.001  0.000     0.000          0.000       0.00
#> b %in% s       0.000  0.001     0.000          0.000       0.00
#> match(b, b)    0.001  0.000     0.000          0.000       0.00
#> b %in% b       0.000  0.001     0.000          0.000       0.00
#> duplicated(b)  0.001  0.000     0.001          0.000       0.00
#> unique(b)      0.000  0.000     0.000          0.000       0.00
#> table(b)       0.003  0.000     0.001          0.000       0.00
#> sort(b)        0.000  0.000     0.000          0.000       0.00
#> order(b)       0.001  0.000     0.001          0.000       0.00
#> rank(b)        0.001  0.000     0.000          0.000       0.00
#> quantile(b)    0.000  0.001     0.001          0.000       0.00
#> summary(b)     0.000  0.001     0.001          0.000       0.00
#> factor(b)      0.002  0.001     0.001          0.000       0.00
#> SESSION        0.013  0.012     0.005          0.008       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> s %in% b       0.000  0.000     0.000          0.000       0.00
#> match(b, s)    0.001  0.000     0.000          0.001       0.00
#> b %in% s       0.000  0.001     0.000          0.000       0.00
#> match(b, b)    0.001  0.000     0.000          0.000       0.00
#> b %in% b       0.000  0.001     0.000          0.000       0.00
#> duplicated(b)  0.001  0.000     0.001          0.000       0.00
#> unique(b)      0.000  0.000     0.000          0.001       0.00
#> table(b)       0.003  0.000     0.001          0.000       0.00
#> sort(b)        0.000  0.000     0.000          0.000       0.00
#> order(b)       0.001  0.000     0.001          0.000       0.00
#> rank(b)        0.001  0.000     0.000          0.001       0.00
#> quantile(b)    0.000  0.001     0.001          0.000       0.00
#> summary(b)     0.000  0.001     0.001          0.000       0.00
#> factor(b)      0.002  0.001     0.001          0.002       0.00
#> SESSION        0.013  0.012     0.005          0.008       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> quantile(b)      NaN  0.000       0.0            NaN        NaN
#> summary(b)       NaN  0.000       0.0            NaN        NaN
#> factor(b)          1  2.000       2.0          1.000        Inf
#> SESSION            1  1.083       2.6          1.625        1.3
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
...
#> SESSION        0.013  0.012     0.005          0.008      0.010
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION          0.005
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN       0.0            NaN        0.0
#> match(s, b)        1    Inf       Inf          1.000        1.0
#> s %in% b         NaN    NaN       NaN            NaN        0.0
#> match(b, s)        1    Inf       Inf          1.000        Inf
#> b %in% s         NaN  0.000       NaN            NaN        NaN
#> match(b, b)        1    Inf       Inf            Inf        Inf
#> b %in% b         NaN  0.000       NaN            NaN        NaN
#> duplicated(b)      1    Inf       1.0            Inf        1.0
#> unique(b)        NaN    NaN       NaN          0.000        NaN
#> table(b)           1    Inf       3.0            Inf        3.0
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)           1    Inf       1.0            Inf        Inf
#> rank(b)            1    Inf       Inf          1.000        Inf
#> quantile(b)      NaN  0.000       0.0            NaN        0.0
#> summary(b)       NaN  0.000       0.0            NaN        0.0
#> factor(b)          1  2.000       2.0          1.000        2.0
#> SESSION            1  1.083       2.6          1.625        1.3
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
