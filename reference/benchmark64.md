...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.007              0          0        0
#> factor   1.000   1.20     1.714            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.007          0.006          0        0
#> factor   1.000   1.20     1.714          2.000        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.007          0.006      0.006        0
#> factor   1.000   1.20     1.714          2.000      2.000      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.007          0.006      0.006    0.002
#> factor   1.000   1.20     1.714          2.000      2.000    6.000
#> 
...
#> SESSION        0.012   0.01     0.007          0.006      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> sort(b)        0.001  0.001     0.000          0.000      0.000
...
#> SESSION        0.012  0.010     0.007          0.006      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> rank(b)        0.001  0.001     0.000          0.000      0.000
#> quantile(b)    0.001  0.000     0.001          0.000      0.000
#> summary(b)     0.000  0.000     0.000          0.000      0.001
...
#> rank(b)            1    1.0       Inf            Inf        Inf
#> quantile(b)        1    Inf     1.000            Inf        Inf
#> summary(b)       NaN    NaN       NaN            NaN        0.0
#> factor(b)          1    1.0     1.000            0.5        0.5
#> SESSION            1    1.2     1.714            2.0        2.0
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
