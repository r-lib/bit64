...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.013     0.003              0          0        0
#> factor    1.00  0.769     3.333            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.013     0.003          0.013          0        0
#> factor    1.00  0.769     3.333          0.769        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.013     0.003          0.013      0.011        0
#> factor    1.00  0.769     3.333          0.769      0.909      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.013     0.003          0.013      0.011    0.005
#> factor    1.00  0.769     3.333          0.769      0.909    2.000
#> 
...
#> SESSION        0.010  0.013     0.003          0.013      0.011
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.769     3.333          0.769      0.909
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           Inf
...
#> s %in% b       0.001  0.000     0.001          0.000      0.000
...
#> s %in% b       0.001  0.000     0.001          0.001      0.000
#> match(b, s)    0.000  0.001     0.001          0.000      0.000
#> b %in% s       0.001  0.001     0.001          0.000      0.000
#> match(b, b)    0.000  0.001     0.004          0.000      0.000
#> b %in% b       0.000  0.001     0.001          0.000      0.000
...
#> s %in% b       0.001  0.000     0.001          0.001      0.001
...
#> rank(b)        0.001  0.000     0.000          0.000      0.000
#> quantile(b)    0.000  0.001     0.000          0.001      0.000
#> summary(b)     0.000  0.001     0.000          0.001      0.001
#> SESSION        0.010  0.013     0.003          0.013      0.011
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> s %in% b           1    Inf     1.000          1.000      1.000
#> match(b, s)      NaN  0.000     0.000            NaN      0.000
#> b %in% s           1  1.000     1.000            Inf        Inf
#> match(b, b)      NaN  0.000     0.000            NaN        NaN
#> b %in% b         NaN  0.000     0.000            NaN        NaN
#> duplicated(b)    NaN  0.000       NaN          0.000        NaN
...
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN  0.000       NaN          0.000        NaN
#> summary(b)       NaN  0.000       NaN          0.000      0.000
#> SESSION            1  0.769     3.333          0.769      0.909
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
