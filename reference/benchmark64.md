...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.011     0.007          0.005          0        0
#> factor   1.000  1.273     2.000          2.800        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.011     0.007          0.005      0.008        0
#> factor   1.000  1.273     2.000          2.800      1.750      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.011     0.007          0.005      0.008    0.006
#> factor   1.000  1.273     2.000          2.800      1.750    2.333
#> 
...
#> SESSION        0.014  0.011     0.007          0.005      0.008
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> rank(b)            1    Inf         1            Inf        Inf
#> quantile(b)      NaN  0.000       NaN            NaN        NaN
#> summary(b)       NaN    NaN         0            0.0        NaN
#> factor(b)          1  2.000         2            2.0        Inf
#> SESSION            1  1.273         2            2.8       1.75
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> summary(b)     0.000  0.000     0.001          0.001      0.000
#> factor(b)      0.002  0.001     0.001          0.001      0.002
#> SESSION        0.014  0.011     0.007          0.005      0.008
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> b %in% b           1    Inf       Inf            Inf        Inf
#> duplicated(b)    NaN  0.000       NaN            0.0        NaN
#> unique(b)        NaN    NaN       NaN            NaN       0.00
#> table(b)           1  2.000       Inf            2.0        Inf
#> sort(b)          NaN    NaN       NaN            NaN       0.00
#> order(b)           1  1.000       Inf            Inf        Inf
#> rank(b)            1    Inf         1            Inf        Inf
#> quantile(b)      NaN  0.000       NaN            NaN       0.00
#> summary(b)       NaN    NaN         0            0.0        NaN
#> factor(b)          1  2.000         2            2.0       1.00
#> SESSION            1  1.273         2            2.8       1.75
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
