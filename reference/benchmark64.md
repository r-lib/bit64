...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.011     0.008              0          0        0
#> factor   1.000  1.182     1.625            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.011     0.008          0.005          0        0
#> factor   1.000  1.182     1.625          2.600        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.011     0.008          0.005      0.008        0
#> factor   1.000  1.182     1.625          2.600      1.625      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.011     0.008          0.005      0.008    0.006
#> factor   1.000  1.182     1.625          2.600      1.625    2.167
#> 
...
#> SESSION        0.013  0.011     0.008          0.005      0.008
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  1.182     1.625            2.6      1.625
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
...
#> order(b)       0.001  0.000     0.000          0.000      0.000
#> rank(b)        0.001  0.001     0.000          0.000      0.000
#> quantile(b)    0.000  0.001     0.005          0.000      0.000
...
#> factor(b)          1  2.000     1.000            Inf        Inf
#> SESSION            1  1.182     1.625            2.6      1.625
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> factor(b)          1  2.000     1.000            2.0        Inf
#> SESSION            1  1.182     1.625            2.6      1.625
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> order(b)       0.001  0.000     0.000          0.000      0.000
#> rank(b)        0.001  0.001     0.000          0.000      0.000
#> quantile(b)    0.000  0.001     0.005          0.000      0.001
#> summary(b)     0.000  0.001     0.001          0.001      0.000
...
#> duplicated(b)    NaN  0.000       NaN            0.0        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf       Inf            Inf      3.000
#> sort(b)          NaN  0.000       NaN            NaN        NaN
#> order(b)           1    Inf       Inf            Inf        Inf
#> rank(b)            1  1.000       Inf            Inf        Inf
#> quantile(b)      NaN  0.000     0.000            NaN      0.000
#> summary(b)       NaN  0.000     0.000            0.0        NaN
#> factor(b)          1  2.000     1.000            2.0      2.000
#> SESSION            1  1.182     1.625            2.6      1.625
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
