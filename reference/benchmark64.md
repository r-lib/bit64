...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.007     0.008              0          0        0
#> factor   1.000  2.000     1.750            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.007     0.008          0.007          0        0
#> factor   1.000  2.000     1.750          2.000        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.007     0.008          0.007      0.006        0
#> factor   1.000  2.000     1.750          2.000      2.333      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.007     0.008          0.007      0.006    0.006
#> factor   1.000  2.000     1.750          2.000      2.333    2.333
#> 
...
#> SESSION        0.014  0.007     0.008          0.007      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> duplicated(b)      1      1       Inf            Inf        Inf
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1      2      2.00            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN      0      0.00            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN      0      0.00            NaN        NaN
#> summary(b)         1      1      1.00            Inf        Inf
#> factor(b)          1      2      2.00            Inf        Inf
#> SESSION            1      2      1.75              2      2.333
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
...
#> order(b)         NaN      0      0.00            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN      0      0.00              0        NaN
#> summary(b)         1      1      1.00            Inf        Inf
#> factor(b)          1      2      2.00              2        Inf
#> SESSION            1      2      1.75              2      2.333
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
...
#> match(s, b)        1    Inf      1.00            Inf      1.000
#> s %in% b         NaN    NaN       NaN            NaN        NaN
#> match(b, s)        1    Inf       Inf            Inf        Inf
#> b %in% s         NaN    NaN       NaN            NaN        NaN
#> match(b, b)        1    Inf       Inf              1        Inf
...
#> order(b)         NaN      0      0.00            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN      0      0.00              0      0.000
#> summary(b)         1      1      1.00            Inf        Inf
#> factor(b)          1      2      2.00              2      2.000
#> SESSION            1      2      1.75              2      2.333
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
