...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.012     0.009          0.005          0        0
#> factor   1.000  1.083     1.444          2.600        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.012     0.009          0.005      0.008        0
#> factor   1.000  1.083     1.444          2.600      1.625      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.012     0.009          0.005      0.008    0.005
#> factor   1.000  1.083     1.444          2.600      1.625    2.600
#> 
...
#> SESSION        0.013  0.012     0.009          0.005      0.008
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  1.083     1.444            2.6      1.625
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
...
#> quantile(b)        1    Inf       Inf            Inf        Inf
#> summary(b)       NaN  0.000       NaN            NaN        NaN
#> factor(b)          1  2.000     2.000            2.0      2.000
#> SESSION            1  1.083     1.444            2.6      1.625
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
