...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.016  0.011         0              0          0        0
#> factor   1.000  1.455       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.016  0.011      0.01              0          0        0
#> factor   1.000  1.455      1.60            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.016  0.011      0.01          0.006          0        0
#> factor   1.000  1.455      1.60          2.667        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.016  0.011      0.01          0.006       0.01        0
#> factor   1.000  1.455      1.60          2.667       1.60      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.016  0.011      0.01          0.006       0.01    0.006
#> factor   1.000  1.455      1.60          2.667       1.60    2.667
#> 
...
#> cache          0.000  0.000      0.00          0.000       0.00
#> match(s, b)    0.000  0.000      0.00          0.000       0.00
#> s %in% b       0.000  0.000      0.00          0.000       0.00
#> match(b, s)    0.001  0.000      0.00          0.000       0.00
#> b %in% s       0.000  0.000      0.00          0.000       0.00
#> match(b, b)    0.001  0.000      0.00          0.000       0.00
#> b %in% b       0.000  0.000      0.00          0.000       0.00
#> duplicated(b)  0.001  0.000      0.00          0.000       0.00
#> unique(b)      0.000  0.000      0.00          0.000       0.00
#> table(b)       0.003  0.000      0.00          0.000       0.00
#> sort(b)        0.000  0.000      0.00          0.000       0.00
#> order(b)       0.001  0.000      0.00          0.000       0.00
#> rank(b)        0.001  0.000      0.00          0.000       0.00
#> quantile(b)    0.001  0.000      0.00          0.000       0.00
#> summary(b)     0.000  0.000      0.00          0.000       0.00
#> factor(b)      0.002  0.000      0.00          0.000       0.00
#> SESSION        0.016  0.011      0.01          0.006       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> s %in% b       0.000  0.000      0.00          0.000       0.00
#> match(b, s)    0.001  0.000      0.00          0.000       0.00
#> b %in% s       0.000  0.001      0.00          0.000       0.00
#> match(b, b)    0.001  0.000      0.00          0.000       0.00
#> b %in% b       0.000  0.000      0.00          0.000       0.00
#> duplicated(b)  0.001  0.000      0.00          0.000       0.00
#> unique(b)      0.000  0.000      0.00          0.000       0.00
#> table(b)       0.003  0.000      0.00          0.000       0.00
#> sort(b)        0.000  0.001      0.00          0.000       0.00
#> order(b)       0.001  0.000      0.00          0.000       0.00
#> rank(b)        0.001  0.001      0.00          0.000       0.00
#> quantile(b)    0.001  0.000      0.00          0.000       0.00
#> summary(b)     0.000  0.000      0.00          0.000       0.00
#> factor(b)      0.002  0.002      0.00          0.000       0.00
#> SESSION        0.016  0.011      0.01          0.006       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> match(s, b)    0.000  0.000     0.000          0.000       0.00
#> s %in% b       0.000  0.000     0.001          0.000       0.00
...
#> rank(b)        0.001  0.001     0.000          0.000       0.00
#> quantile(b)    0.001  0.000     0.001          0.000       0.00
#> summary(b)     0.000  0.000     0.000          0.000       0.00
#> factor(b)      0.002  0.002     0.001          0.000       0.00
#> SESSION        0.016  0.011     0.010          0.006       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, s)    0.001  0.000     0.000          0.000       0.00
#> b %in% s       0.000  0.001     0.000          0.000       0.00
#> match(b, b)    0.001  0.000     0.000          0.001       0.00
#> b %in% b       0.000  0.000     0.000          0.000       0.00
#> duplicated(b)  0.001  0.000     0.000          0.001       0.00
#> unique(b)      0.000  0.000     0.000          0.000       0.00
#> table(b)       0.003  0.000     0.001          0.000       0.00
#> sort(b)        0.000  0.001     0.000          0.000       0.00
#> order(b)       0.001  0.000     0.000          0.000       0.00
#> rank(b)        0.001  0.001     0.000          0.000       0.00
#> quantile(b)    0.001  0.000     0.001          0.000       0.00
#> summary(b)     0.000  0.000     0.000          0.001       0.00
#> factor(b)      0.002  0.002     0.001          0.001       0.00
#> SESSION        0.016  0.011     0.010          0.006       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> match(b, s)        1    Inf       Inf            Inf        Inf
#> b %in% s         NaN  0.000       NaN            NaN        NaN
#> match(b, b)        1    Inf       Inf          1.000        Inf
#> b %in% b         NaN    NaN       NaN            NaN        NaN
#> duplicated(b)      1    Inf       Inf          1.000        Inf
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf       3.0            Inf        Inf
#> sort(b)          NaN  0.000       NaN            NaN        NaN
#> order(b)           1    Inf       Inf            Inf        Inf
#> rank(b)            1  1.000       Inf            Inf        Inf
#> quantile(b)        1    Inf       1.0            Inf        Inf
#> summary(b)       NaN    NaN       NaN          0.000        NaN
#> factor(b)          1  1.000       2.0          2.000        Inf
#> SESSION            1  1.455       1.6          2.667        1.6
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> duplicated(b)  0.001  0.000     0.000          0.001      0.000
...
#> quantile(b)    0.001  0.000     0.001          0.000      0.000
#> summary(b)     0.000  0.000     0.000          0.001      0.000
#> factor(b)      0.002  0.002     0.001          0.001      0.002
#> SESSION        0.016  0.011     0.010          0.006      0.010
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> quantile(b)        1    Inf       1.0            Inf        Inf
#> summary(b)       NaN    NaN       NaN          0.000        NaN
#> factor(b)          1  1.000       2.0          2.000        1.0
#> SESSION            1  1.455       1.6          2.667        1.6
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
