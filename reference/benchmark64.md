...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.011     0.005              0          0        0
#> factor   1.000  1.091     2.400            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.011     0.005          0.005          0        0
#> factor   1.000  1.091     2.400          2.400        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.011     0.005          0.005      0.006        0
#> factor   1.000  1.091     2.400          2.400      2.000      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.011     0.005          0.005      0.006    0.004
#> factor   1.000  1.091     2.400          2.400      2.000    3.000
#> 
...
#> SESSION        0.012  0.011     0.005          0.005      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN  0.000       NaN            NaN        NaN
#> summary(b)         1  1.000       1.0            Inf        Inf
#> factor(b)          1  1.000       1.0            Inf        Inf
#> SESSION            1  1.091       2.4            2.4          2
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)        NaN  0.000       NaN            0.0        NaN
#> table(b)           1    Inf       Inf            Inf        Inf
#> sort(b)            1    Inf       Inf            Inf        Inf
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
...
#> match(s, b)      NaN    NaN       NaN            NaN        NaN
#> s %in% b         NaN    NaN       NaN            NaN        NaN
#> match(b, s)      NaN    NaN       NaN            NaN        0.0
#> b %in% s         NaN    NaN       0.0            NaN        NaN
#> match(b, b)        1    Inf       Inf            Inf        1.0
#> b %in% b         NaN    NaN       NaN            0.0        NaN
#> duplicated(b)    NaN    NaN       NaN            NaN        0.0
#> unique(b)        NaN  0.000       NaN            0.0        NaN
#> table(b)           1    Inf       Inf            Inf        2.0
#> sort(b)            1    Inf       Inf            Inf        Inf
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN  0.000       NaN            0.0        NaN
#> summary(b)         1  1.000       1.0            Inf        Inf
#> factor(b)          1  1.000       1.0            1.0        0.5
#> SESSION            1  1.091       2.4            2.4        2.0
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
