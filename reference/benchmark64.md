...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.012          0.007          0        0
#> factor   1.000  0.786     0.917          1.571        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.012          0.007      0.009        0
#> factor   1.000  0.786     0.917          1.571      1.222      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.012          0.007      0.009    0.008
#> factor   1.000  0.786     0.917          1.571      1.222    1.375
#> 
...
#> SESSION        0.011  0.014     0.012          0.007      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.786     0.917          1.571      1.222
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           Inf
