...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.008     0.008          0.007          0        0
#> factor   1.000  1.750     1.750          2.000        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.008     0.008          0.007      0.009        0
#> factor   1.000  1.750     1.750          2.000      1.556      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.008     0.008          0.007      0.009    0.005
#> factor   1.000  1.750     1.750          2.000      1.556    2.800
#> 
...
#> SESSION        0.014  0.008     0.008          0.007      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN   0.00       NaN            NaN        NaN
#> summary(b)       NaN   0.00      0.00            NaN        NaN
#> factor(b)          1   2.00      2.00            Inf        Inf
#> SESSION            1   1.75      1.75              2      1.556
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> duplicated(b)    NaN   0.00       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1   2.00       Inf              2        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN   0.00       NaN            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN   0.00       NaN            NaN        NaN
#> summary(b)       NaN   0.00      0.00            NaN        NaN
#> factor(b)          1   2.00      2.00              2        Inf
#> SESSION            1   1.75      1.75              2      1.556
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> factor(b)      0.002  0.001     0.001          0.001      0.080
#> SESSION        0.014  0.008     0.008          0.007      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN   0.00       NaN            NaN        NaN
#> summary(b)       NaN   0.00      0.00            NaN      0.000
#> factor(b)          1   2.00      2.00              2      0.025
#> SESSION            1   1.75      1.75              2      1.556
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
