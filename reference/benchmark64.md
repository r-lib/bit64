...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.015         0              0          0        0
#> factor   1.000  0.600       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.015      0.01              0          0        0
#> factor   1.000  0.600      0.90            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.015      0.01          0.006          0        0
#> factor   1.000  0.600      0.90          1.500        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.015      0.01          0.006      0.006        0
#> factor   1.000  0.600      0.90          1.500      1.500      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.009  0.015      0.01          0.006      0.006    0.013
#> factor   1.000  0.600      0.90          1.500      1.500    0.692
#> 
...
#> SESSION        0.009  0.015      0.01          0.006      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION        0.009  0.015     0.010          0.006      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, b)      NaN    0.0       0.0            NaN        NaN
#> b %in% b         NaN    0.0       0.0            NaN        NaN
#> duplicated(b)    NaN    0.0       NaN            NaN        NaN
...
#> quantile(b)      NaN    0.0       0.0            NaN        NaN
#> summary(b)       NaN    0.0       0.0            NaN        NaN
#> SESSION            1    0.6       0.9            1.5        1.5
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> match(s, b)    0.000  0.000     0.001          0.004      0.000
...
#> match(s, b)      NaN    NaN       0.0            0.0        NaN
#> s %in% b         NaN    NaN       0.0            0.0        NaN
#> match(b, s)      NaN    NaN       0.0            NaN        NaN
#> b %in% s         NaN    NaN       0.0            NaN        NaN
#> match(b, b)      NaN    0.0       0.0            NaN        NaN
#> b %in% b         NaN    0.0       0.0            NaN        NaN
...
#> b %in% s       0.000  0.000     0.001          0.000      0.001
...
#> SESSION          0.013
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN       NaN            0.0        0.0
#> match(s, b)      NaN    NaN       0.0            0.0        NaN
#> s %in% b         NaN    NaN       0.0            0.0        NaN
#> match(b, s)      NaN    NaN       0.0            NaN        0.0
#> b %in% s         NaN    NaN       0.0            NaN        0.0
#> match(b, b)      NaN    0.0       0.0            NaN        0.0
#> b %in% b         NaN    0.0       0.0            NaN        0.0
#> duplicated(b)    NaN    0.0       NaN            NaN        NaN
#> unique(b)        NaN    NaN       0.0            NaN        NaN
#> table(b)           1    2.0       Inf            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
