...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014         0              0          0        0
#> factor   1.000  0.786       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.017              0          0        0
#> factor   1.000  0.786     0.647            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.017          0.006          0        0
#> factor   1.000  0.786     0.647          1.833        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.017          0.006      0.012        0
#> factor   1.000  0.786     0.647          1.833      0.917      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.014     0.017          0.006      0.012    0.005
#> factor   1.000  0.786     0.647          1.833      0.917    2.200
#> 
...
#> SESSION        0.011  0.014     0.017          0.006      0.012
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.786     0.647          1.833      0.917
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
#> s %in% b           NaN
...
#> quantile(b)        1    Inf     1.000            Inf        Inf
...
#> sort(b)        0.001  0.000     0.000          0.000      0.000
#> order(b)       0.000  0.001     0.001          0.004      0.000
#> rank(b)        0.001  0.000     0.001          0.000      0.000
...
#> b %in% s         NaN  0.000     0.000          0.000        NaN
#> match(b, b)        1  1.000     1.000          1.000        Inf
#> b %in% b         NaN    NaN     0.000          0.000        NaN
#> duplicated(b)      1    Inf       Inf            Inf        Inf
#> unique(b)        NaN  0.000       NaN            NaN        NaN
#> table(b)           1    Inf     2.000          2.000        Inf
#> sort(b)            1    Inf       Inf            Inf        Inf
#> order(b)         NaN  0.000     0.000          0.000        NaN
#> rank(b)            1    Inf     1.000            Inf        Inf
#> quantile(b)        1    Inf     1.000          1.000        Inf
...
#> table(b)       0.002  0.000     0.001          0.001      0.000
#> sort(b)        0.001  0.000     0.000          0.000      0.000
#> order(b)       0.000  0.001     0.001          0.004      0.001
#> rank(b)        0.001  0.000     0.001          0.000      0.000
...
#> b %in% s         NaN  0.000     0.000          0.000      0.000
#> match(b, b)        1  1.000     1.000          1.000      1.000
#> b %in% b         NaN    NaN     0.000          0.000      0.000
#> duplicated(b)      1    Inf       Inf            Inf        Inf
#> unique(b)        NaN  0.000       NaN            NaN        NaN
#> table(b)           1    Inf     2.000          2.000        Inf
#> sort(b)            1    Inf       Inf            Inf        Inf
...
#> rank(b)            1    Inf     1.000            Inf        Inf
#> quantile(b)        1    Inf     1.000          1.000      1.000
#> summary(b)       NaN  0.000     0.000          0.000        NaN
#> SESSION            1  0.786     0.647          1.833      0.917
#>               allcache
#> cache              NaN
