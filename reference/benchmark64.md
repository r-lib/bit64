...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014   0.01         0              0          0        0
#> factor   1.000   1.40       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014   0.01     0.012              0          0        0
#> factor   1.000   1.40     1.167            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014   0.01     0.012           0.01          0        0
#> factor   1.000   1.40     1.167           1.40        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014   0.01     0.012           0.01      0.009        0
#> factor   1.000   1.40     1.167           1.40      1.556      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014   0.01     0.012           0.01      0.009    0.118
#> factor   1.000   1.40     1.167           1.40      1.556    0.119
#> 
...
#> cache          0.000   0.00     0.000           0.00      0.000
#> match(s, b)    0.000   0.00     0.000           0.00      0.000
#> s %in% b       0.000   0.00     0.000           0.00      0.000
#> match(b, s)    0.000   0.00     0.000           0.00      0.000
#> b %in% s       0.000   0.00     0.000           0.00      0.000
#> match(b, b)    0.000   0.00     0.000           0.00      0.000
#> b %in% b       0.001   0.00     0.000           0.00      0.000
#> duplicated(b)  0.000   0.00     0.000           0.00      0.000
#> unique(b)      0.000   0.00     0.000           0.00      0.000
#> table(b)       0.002   0.00     0.000           0.00      0.000
#> sort(b)        0.000   0.00     0.000           0.00      0.000
#> order(b)       0.000   0.00     0.000           0.00      0.000
#> rank(b)        0.001   0.00     0.000           0.00      0.000
#> quantile(b)    0.001   0.00     0.000           0.00      0.000
#> summary(b)     0.000   0.00     0.000           0.00      0.000
#> factor(b)      0.001   0.00     0.000           0.00      0.000
#> SESSION        0.014   0.01     0.012           0.01      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> factor(b)      0.001  0.001     0.000           0.00      0.000
#> SESSION        0.014  0.010     0.012           0.01      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> b %in% s       0.000  0.000     0.000           0.00      0.000
#> match(b, b)    0.000  0.000     0.000           0.00      0.000
#> b %in% b       0.001  0.000     0.001           0.00      0.000
#> duplicated(b)  0.000  0.000     0.000           0.00      0.000
#> unique(b)      0.000  0.000     0.000           0.00      0.000
#> table(b)       0.002  0.001     0.000           0.00      0.000
#> sort(b)        0.000  0.000     0.000           0.00      0.000
...
#> factor(b)      0.001  0.001     0.001           0.00      0.000
#> SESSION        0.014  0.010     0.012           0.01      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> b %in% b       0.001  0.000     0.001          0.001      0.000
...
#> factor(b)      0.001  0.001     0.001          0.002      0.000
#> SESSION        0.014  0.010     0.012          0.010      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> factor(b)      0.001  0.001     0.001          0.002      0.002
#> SESSION        0.014  0.010     0.012          0.010      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> quantile(b)        1    1.0       Inf            Inf        Inf
#> summary(b)       NaN    0.0     0.000            NaN      0.000
#> factor(b)          1    1.0     1.000            0.5      0.500
#> SESSION            1    1.4     1.167            1.4      1.556
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
