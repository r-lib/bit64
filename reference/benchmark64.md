...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.007         0              0          0        0
#> factor   1.000  2.000       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.007     0.009              0          0        0
#> factor   1.000  2.000     1.556            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.007     0.009          0.006          0        0
#> factor   1.000  2.000     1.556          2.333        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.007     0.009          0.006      0.007        0
#> factor   1.000  2.000     1.556          2.333      2.000      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.007     0.009          0.006      0.007    0.093
#> factor   1.000  2.000     1.556          2.333      2.000    0.151
#> 
...
#> SESSION        0.014  0.007     0.009          0.006      0.007
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> factor(b)      0.001  0.002     0.001          0.001      0.000
#> SESSION        0.014  0.007     0.009          0.006      0.007
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> factor(b)          1    0.5     1.000          1.000        Inf
#> SESSION            1    2.0     1.556          2.333          2
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> quantile(b)    0.001  0.000     0.001          0.000      0.000
#> summary(b)     0.000  0.000     0.000          0.001      0.000
#> factor(b)      0.001  0.002     0.001          0.001      0.002
#> SESSION        0.014  0.007     0.009          0.006      0.007
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> quantile(b)        1    Inf     1.000            Inf        Inf
#> summary(b)       NaN    NaN       NaN          0.000        NaN
#> factor(b)          1    0.5     1.000          1.000        0.5
#> SESSION            1    2.0     1.556          2.333        2.0
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
