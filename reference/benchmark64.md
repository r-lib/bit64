...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.019         0              0          0        0
#> factor   1.000  0.632       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.019     0.008              0          0        0
#> factor   1.000  0.632     1.500            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.019     0.008          0.006          0        0
#> factor   1.000  0.632     1.500          2.000        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.019     0.008          0.006      0.011        0
#> factor   1.000  0.632     1.500          2.000      1.091      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.019     0.008          0.006      0.011    0.013
#> factor   1.000  0.632     1.500          2.000      1.091    0.923
#> 
...
#> SESSION        0.012  0.019     0.008          0.006      0.011
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> quantile(b)    0.001  0.001     0.000          0.000      0.000
#> summary(b)     0.000  0.001     0.004          0.000      0.000
#> SESSION        0.012  0.019     0.008          0.006      0.011
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> b %in% b       0.000  0.001     0.000          0.001      0.000
#> duplicated(b)  0.001  0.000     0.000          0.000      0.000
#> unique(b)      0.000  0.000     0.000          0.001      0.000
#> table(b)       0.002  0.001     0.000          0.000      0.000
#> sort(b)        0.001  0.000     0.000          0.000      0.000
#> order(b)       0.000  0.001     0.001          0.000      0.000
#> rank(b)        0.001  0.001     0.001          0.001      0.000
#> quantile(b)    0.001  0.001     0.000          0.000      0.000
#> summary(b)     0.000  0.001     0.004          0.001      0.000
#> SESSION        0.012  0.019     0.008          0.006      0.011
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> SESSION          0.013
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN       0.0              0        NaN
#> match(s, b)        1  1.000       1.0              1        Inf
#> s %in% b         NaN  0.000       0.0              0        NaN
#> match(b, s)        1  1.000       1.0              1        Inf
#> b %in% s         NaN  0.000       0.0              0        NaN
#> match(b, b)        1  1.000       1.0              1        Inf
#> b %in% b         NaN  0.000       NaN              0        NaN
#> duplicated(b)      1    Inf       Inf            Inf        Inf
#> unique(b)        NaN    NaN       NaN              0        NaN
#> table(b)           1  2.000       Inf            Inf        Inf
#> sort(b)            1    Inf       Inf            Inf        Inf
#> order(b)         NaN  0.000       0.0            NaN        NaN
#> rank(b)            1  1.000       1.0              1        Inf
#> quantile(b)        1  1.000       Inf            Inf        Inf
#> summary(b)       NaN  0.000       0.0              0        NaN
#> SESSION            1  0.632       1.5              2      1.091
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
...
#> match(b, s)    0.001  0.001     0.001          0.001      0.000
#> b %in% s       0.000  0.001     0.001          0.001      0.000
#> match(b, b)    0.001  0.001     0.001          0.001      0.001
#> b %in% b       0.000  0.001     0.000          0.001      0.001
#> duplicated(b)  0.001  0.000     0.000          0.000      0.000
#> unique(b)      0.000  0.000     0.000          0.001      0.000
#> table(b)       0.002  0.001     0.000          0.000      0.001
#> sort(b)        0.001  0.000     0.000          0.000      0.000
#> order(b)       0.000  0.001     0.001          0.000      0.001
#> rank(b)        0.001  0.001     0.001          0.001      0.000
#> quantile(b)    0.001  0.001     0.000          0.000      0.001
#> summary(b)     0.000  0.001     0.004          0.001      0.001
#> SESSION        0.012  0.019     0.008          0.006      0.011
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> SESSION          0.013
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN       0.0              0      0.000
#> match(s, b)        1  1.000       1.0              1        Inf
#> s %in% b         NaN  0.000       0.0              0        NaN
#> match(b, s)        1  1.000       1.0              1        Inf
#> b %in% s         NaN  0.000       0.0              0        NaN
#> match(b, b)        1  1.000       1.0              1      1.000
#> b %in% b         NaN  0.000       NaN              0      0.000
#> duplicated(b)      1    Inf       Inf            Inf        Inf
#> unique(b)        NaN    NaN       NaN              0        NaN
#> table(b)           1  2.000       Inf            Inf      2.000
#> sort(b)            1    Inf       Inf            Inf        Inf
#> order(b)         NaN  0.000       0.0            NaN      0.000
#> rank(b)            1  1.000       1.0              1        Inf
#> quantile(b)        1  1.000       Inf            Inf      1.000
#> summary(b)       NaN  0.000       0.0              0      0.000
#> SESSION            1  0.632       1.5              2      1.091
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
