...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.012     0.011              0          0        0
#> factor   1.000  1.000     1.091            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.012     0.011          0.009          0        0
#> factor   1.000  1.000     1.091          1.333        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.012     0.011          0.009      0.013        0
#> factor   1.000  1.000     1.091          1.333      0.923      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.012     0.011          0.009      0.013    0.009
#> factor   1.000  1.000     1.091          1.333      0.923    1.333
#> 
...
#> SESSION        0.012  0.012     0.011          0.009      0.013
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> summary(b)     0.000  0.000     0.005          0.000      0.000
#> SESSION        0.012  0.012     0.011          0.009      0.013
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> rank(b)        0.001  0.000     0.000          0.000      0.000
#> quantile(b)    0.001  0.000     0.001          0.000      0.000
#> summary(b)     0.000  0.000     0.005          0.001      0.000
#> SESSION        0.012  0.012     0.011          0.009      0.013
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> match(b, b)    0.000  0.000     0.000          0.000      0.001
...
#> match(b, s)      NaN      0       NaN          0.000      0.000
#> b %in% s         NaN      0       NaN            NaN      0.000
#> match(b, b)      NaN    NaN       NaN            NaN      0.000
#> b %in% b         NaN    NaN     0.000            NaN      0.000
#> duplicated(b)    NaN    NaN     0.000            NaN        NaN
#> unique(b)        NaN      0       NaN            NaN      0.000
#> table(b)           1    Inf     2.000            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN      0       NaN            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
