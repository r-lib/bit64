...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.015     0.016              0          0        0
#> factor   1.000  0.867     0.813            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.015     0.016          0.015          0        0
#> factor   1.000  0.867     0.813          0.867        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.015     0.016          0.015      0.017        0
#> factor   1.000  0.867     0.813          0.867      0.765      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.013  0.015     0.016          0.015      0.017    0.009
#> factor   1.000  0.867     0.813          0.867      0.765    1.444
#> 
...
#> SESSION        0.013  0.015     0.016          0.015      0.017
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.867     0.813          0.867      0.765
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
...
#> order(b)           1    Inf     1.000            Inf        Inf
#> rank(b)            1    Inf     1.000            Inf        Inf
#> quantile(b)      NaN    NaN     0.000          0.000        NaN
#> summary(b)       NaN  0.000     0.000          0.000        NaN
#> factor(b)          1  1.000     1.000          1.000        Inf
#> SESSION            1  0.867     0.813          0.867      0.765
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> ordercache factor(b)
#> seconds              32-bit 64-bit hashcache sortordercache ordercache
#> cache          0.000  0.000     0.000          0.000      0.001
#> match(s, b)    0.000  0.001     0.000          0.000      0.000
#> s %in% b       0.000  0.001     0.000          0.000      0.000
...
#> sort(b)          NaN  0.000       NaN            NaN        NaN
#> order(b)           1    Inf     1.000            Inf        Inf
#> rank(b)            1    Inf     1.000            Inf      1.000
#> quantile(b)      NaN    NaN     0.000          0.000        NaN
#> summary(b)       NaN  0.000     0.000          0.000      0.000
#> factor(b)          1  1.000     1.000          1.000      1.000
#> SESSION            1  0.867     0.813          0.867      0.765
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
