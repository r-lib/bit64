...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.009     0.008              0          0        0
#> factor   1.000  1.222     1.375            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.009     0.008          0.008          0        0
#> factor   1.000  1.222     1.375          1.375        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.009     0.008          0.008      0.006        0
#> factor   1.000  1.222     1.375          1.375      1.833      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.009     0.008          0.008      0.006    0.005
#> factor   1.000  1.222     1.375          1.375      1.833    2.200
#> 
...
#> SESSION        0.011  0.009     0.008          0.008      0.006
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  1.222     1.375          1.375      1.833
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
...
#> factor(b)          1  2.000     2.000          2.000        Inf
#> SESSION            1  1.222     1.375          1.375      1.833
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> summary(b)       NaN  0.000       NaN          0.000        NaN
#> factor(b)          1  2.000     2.000          2.000      2.000
#> SESSION            1  1.222     1.375          1.375      1.833
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
