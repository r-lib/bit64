...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.016         0              0          0        0
#> factor   1.000  0.750       Inf            Inf        Inf      Inf
#> 
#> === hashcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.016     0.009              0          0        0
#> factor   1.000  0.750     1.333            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.016     0.009          0.006          0        0
#> factor   1.000  0.750     1.333          2.000        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.016     0.009          0.006      0.009        0
#> factor   1.000  0.750     1.333          2.000      1.333      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.016     0.009          0.006      0.009    0.004
#> factor   1.000  0.750     1.333          2.000      1.333    3.000
#> 
...
#> SESSION        0.012  0.016     0.009          0.006      0.009
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> b %in% b         NaN    NaN       NaN            NaN        NaN
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)        NaN   0.00       NaN            NaN        NaN
#> table(b)           1    Inf       Inf            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN   0.00       NaN            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN   0.00       NaN            NaN        NaN
#> summary(b)         1   1.00       Inf            Inf        Inf
#> factor(b)          1   2.00       Inf            Inf        Inf
#> SESSION            1   0.75     1.333              2      1.333
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
